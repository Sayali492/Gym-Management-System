        ...
        <div class="form_wrapper">
            <div class="form_container">
                <div class="title_container">
                    <h2>Register a Trainer</h2>
                </div>
                <div class="row clearfix">
                    <div class="">
                        <div class="input_field"> <span><i aria-hidden="true" class="fa fa-user"></i></span>
                            <input type="text" name="i_id" placeholder="Instructor ID" required />
                        </div>
                        <div class="row clearfix">
                            <div class="col_half">
                                <div class="input_field"> <span><i aria-hidden="true" class="fa fa-user"></i></span>
                                    <input type="text" name="i_name" placeholder="Name" required />
                                </div>
                            </div>
                            <!-- <div class="col_half">
                <div class="input_field"> <span><i aria-hidden="true" class="fa fa-user"></i></span>
                  <input type="text" name="last_name" placeholder="Last Name" required />
                        ...
                        <div class="input_field"> <span><i aria-hidden="true" class="fa fa-burn"></i></span>
                            <input type="text" name="workout_id" placeholder="Workout ID" required />
                        </div>
            ...
            <div class="input_field"> <span><i aria-hidden="true" class="fa fa-lock"></i></span>
              <input type="password" name="confirm_password" placeholder="Re-type Password" />
                        ...
                        <input class="button" type="submit" name="tra_submit" value="Register" />
