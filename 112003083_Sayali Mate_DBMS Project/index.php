...
<html lang="en">
  ...
  <body style="background:url('images/4.jpg'); background-size: cover;">
    <div class="container-fluid" style="margin-top:60px;margin-bottom:60px;color:#34495E; margin-left:375px;">
      <div class="row">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <form class="form-group" method="POST" action="func.php">
                ...
                <center><input type="submit" id="inputbtn" name="login_submit" value="Login" class="btn btn-primary"><a href="func.php"></a></center>
              </form>
